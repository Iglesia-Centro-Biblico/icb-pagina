<template>
  ...
  <div id="visitanos" class="icb-visitanos">
    <div class="icb-visitanos__content">
      ...
      <div class="icb-visitanos__content-info">
        ...
        <p class="icb-visitanos__content-info-hora">19:30 - 21:00 hrs</p>
  ...
  <div id="nosotros" class="icb-que-creemos">
    ...
    <accordion class="icb-que-creemos__declaracion-mobile" :multi="true">
      <accordion-item v-for="seccion in DECLARACION_DE_FE" :key="seccion.titulo" :label="seccion.titulo" :defaultIsOpen="false">
    ...
    <div class="icb-que-creemos__declaracion-desktop">
      ...
      <div class="icb-que-creemos__info">
        <p  v-for="(explicacion, i) in DECLARACION_DE_FE[selectedIndex].explicacion" :key="explicacion.id+'-'+i" :class="['icb-que-creemos__explicacion', `child-${explicacion.child || 1}`]">
